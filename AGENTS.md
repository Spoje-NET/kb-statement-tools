...
**Purpose**: kb Statement Tools
**Status**: Active
**Repository**: git@github.com:Spoje-NET/kb-statement-tools.git
...
git clone git@github.com:Spoje-NET/kb-statement-tools.git
cd kb-statement-tools
